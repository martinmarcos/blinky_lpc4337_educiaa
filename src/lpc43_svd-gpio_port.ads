...
package LPC43_SVD.GPIO_PORT is
   pragma Preelaborate;
   ...
   type B_Register is record
      ...
      PBYTE        : Boolean := False;
      --  unspecified
      Reserved_1_7 : LPC43_SVD.UInt7 := 16#0#;
   end record
   ...
   --  Word pin registers port 0 to 5
   type W_Registers is array (0 .. 255) of LPC43_SVD.UInt32
     with Volatile;
